...
def model_training()->None:
    try:
        ...
        config_path='/opt/airflow/src/config.json'
        ...
        with mlflow.start_run(run_name='knn_trained_model') as run:
                ...
                with open('/opt/airflow/config/knn_model.pkl','wb') as f:
        ...
        with mlflow.start_run(run_name='dt_trained_model') as run:
            ...
            run_id=run.info.run_id
            mlflow.register_model(
            model_uri=f'runs:/{run_id}/decision_trees_model',
            name='Decision_Trees_trained_model' )

            with open('/opt/airflow/config/dt_model.pkl','wb') as f:
